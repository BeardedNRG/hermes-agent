...
export const nousTheme: DesktopTheme = {
  ...
  // ── PRISM: cinema-black glass shell with iridescent-cyan accents + white
  // hairline trim, matched to the Panel's holographic liquid-chrome skin so
  // chat chrome, topbar, and sidebar accents read as one app. ──────────────────
  darkColors: {
    background: '#050506',
    foreground: '#ededf2',
    card: '#0e0f15',
    cardForeground: '#ededf2',
    muted: '#13141b',
    mutedForeground: '#9aa3b8',
    popover: '#0c0d12',
    popoverForeground: '#ededf2',
    primary: '#34e7ff',
    primaryForeground: '#03121a',
    secondary: '#17181f',
    secondaryForeground: '#e8eaf2',
    accent: '#15323a',
    accentForeground: '#e9feff',
    ...
    destructive: '#ff5d7e',
    destructiveForeground: '#ffffff',
    sidebarBackground: '#08080b',
    sidebarBorder: 'rgba(255, 255, 255, 0.08)',
    userBubble: '#14151c',
    userBubbleBorder: 'rgba(0, 234, 255, 0.25)'
  },
  typography: {
